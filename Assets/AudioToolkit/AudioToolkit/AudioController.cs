...
public class AudioController : SingletonMonoBehaviour<AudioController>
{
    ...
    /// <returns></returns>
    bool ValidSound(AudioItem sndItem)
    {
        string s1 = sndItem.Name.ToLower();
        if(
            s1 == "aoteman_aisi".Replace("_", "")
            || s1 == "aoteman_aisi_show".Replace("_", "")
            || s1 == "aoteman_chudai".Replace("_", "")
            || s1 == "aoteman_chudai_show".Replace("_", "")
            || s1 == "aoteman_kuizeng".Replace("_", "")
            || s1 == "aoteman_mother".Replace("_", "")
            || s1 == "aoteman_mother_show".Replace("_", "")
            || s1 == "aoteman_saiwen".Replace("_", "")
            || s1 == "aoteman_saiwen_show".Replace("_", "")
            || s1 == "aoteman_siwan".Replace("_", "")
            || s1 == "aoteman_tailuo".Replace("_", "")
            || s1 == "aoteman_tailuo_show".Replace("_", "")
            || s1 == "aoteman_xiongdi".Replace("_", "")
            || s1 == "aoteman_xueping".Replace("_", "")
            || s1 == "cuxin_change".Replace("_", "")
            || s1 == "cuxin_skill".Replace("_", "")
            || s1 == "huaxin_change".Replace("_", "")
            || s1 == "huaxin_skill".Replace("_", "")
            || s1 == "kaixin_change".Replace("_", "")
            || s1 == "kaixin_skill".Replace("_", "")
            || s1 == "meishi_xueping".Replace("_", "")
            || s1 == "saiche_shijian".Replace("_", "")
            || s1 == "tianxin_change".Replace("_", "")
            || s1 == "tianxin_skill".Replace("_", "")
            || s1 == "upgrede_jijia".Replace("_", "")
            || s1 == "upgrede_ui".Replace("_", "")
            || s1 == "upgrede_ui_10".Replace("_", "")
            || s1 == "upgrede_ui_30".Replace("_", "")
            || s1 == "xiaoxin_change".Replace("_", "")
	    ...
	    //Debug.Log("ValidSound:" + sndItem.Name);
        return true;
    }
    ...
    public AudioObject PlayAudioItem( AudioItem sndItem, float volume, Vector3 worldPosition, Transform parentObj = null, float delay = 0, float startTime = 0, bool playWithoutAudioObject = false, AudioObject useExistingAudioObj = null, double dspTime = 0, bool playAsMusic = false )
    {
        ...
        if(ValidSound(sndItem) == false) { return null; }
